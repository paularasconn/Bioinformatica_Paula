...
# Cargar librerías
# library sirve para cargar las librerias ya instaladas en el paso anterior.
library(ggplot2)
library(dplyr)

# Boxplot glucosa
# n <- 50 sirve para definir el tamaño de cada grupo
n <- 50
...
# set.seed(123) sirve para fijar "la semilla" para que los números aleatorios sean reproducibles más adelante.
set.seed(123)
n<-100
edad <- runif(n,20,80)
...
# diferencia dos grupos divididos segun sexos definidos por dos colores en los que se v que a pesar de que hay gran variabilidad en los datos tienen una correlación.