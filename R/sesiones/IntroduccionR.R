...
1+1
# resultado correcto, nos da 2

2+3*4
# resultado correcto, nos da 14

3^2
# resultado correcto, nos da 9

exp(1)
# resultado correcto, nos da 2.718282

sqrt(10)
# resultado correcto, nos da 3.162278

pi
# resultado correcto, nos da 3.141593

2*pi*6378 #circunferencia de la Tierra
# el resultado en este caso nos da 40074.16

# EJERCICIO:
# Calcula el área de un círculo de radio 10 (A=pi*r^2).
pi * (10^2)
# el resultado es 314.1593
...
# como se distinguen mayúsculas y minúsculas, en este caso nos da error porque no encuentra el objeto o valor "Z"
This.Year<-2023
...
mi_edad <- 21
mi_nombre <- "Paula Rascon"
me_gusta_R <- TRUE

# ahora, para ver si lo hemos hecho correctamente hacemos lo siguiente para visualizarlo:
mi_edad
mi_nombre
me_gusta_R
...
sqrt(x) #aplicacion de la funcion sqrt() sobre todos los elementos del vector
	# resultado: 1.414214 0.000000 0.000000 2.000000
...
mis_numeros <- c(4, 7, 11, 17, 47)

# Ahora, calculamos la media con mean:
mean(mis_numeros)
# el resultado en est ecaso es 17.2
...
mi_vector
# ahora obtenemos lo siguiente: 1  4  9 16 25 36
